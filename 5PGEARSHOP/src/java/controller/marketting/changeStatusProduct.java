...
@WebServlet(name = "changeStatusProduct", urlPatterns = {"/marketting/changestatusproduct"})
public class changeStatusProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet changeStatusProduct</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet changeStatusProduct at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        if (productIdParam != null) {
            ...
            if (product != null) {
                ...
                if (success) {
                    ...
                    if (queryString != null) {
                        response.sendRedirect("listproductmarketting?" + queryString);
                    } else {
                        response.sendRedirect("listproductmarketting");
                    }
                } else {
