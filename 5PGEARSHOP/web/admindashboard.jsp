        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"> 
                    ...
                    %>
                    <h2 style="margin-top: 20px; margin-bottom: 20px">Admin Dashboard</h2>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <p>Success: <span id="order-success">${successCount}</span></p>
                                    <p>Cancelled: <span id="order-cancelled">${cancelledCount}</span></p>
                                    <p>Submitted: <span id="order-submitted">${submittedCount}</span></p>
